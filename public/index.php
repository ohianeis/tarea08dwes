...
//echo password_hash("ohianeis", PASSWORD_DEFAULT);
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.success){ 
                   ...
                   // window.location.href = "buscador.php"; // Redirige manualmente a la página buscador
                } else {
                    ...
                    $('#erroresLogin').html(erroresLogin); // Muestra los errores en el frontend
                }
            },
