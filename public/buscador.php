...
//var_dump($nombreJugador, $apellidoJugador);
//echo '<br>';
...
<head>
    ...
    <style>
        ...
        /* Resaltado rojo al pasar el mouse */
        tbody td:hover {
...
<body style="background-color: #d3d3d3;"> <!-- Fondo blanco -->
   ...
   style="position: fixed; top: 10px; background-color: #003197; left: 20px; width: 150px; height: 40px; padding: 6px 10px; border-radius: 6px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); font-size: 14px;">
    <i class="bi bi-box-arrow-left me-1"></i> Salir
        ...
        <!-- CONTENEDOR CENTRAL (Cabecera + Buscador + Tabla) -->
        <div class="col-md-12">
            <!-- CABECERA CON LOGO -->
            <div class="p-3 rounded bg-white shadow-sm text-center">
                ...
                <!-- CONTENIDO PRINCIPAL (Buscador + Tabla) -->
...
<script>
    //realiza busqueda al dar botón buscar
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    Swal.fire({
                        title: "Error",
                        text: response.error || "No se pudo añadir el jugador",
                        icon: "error",
                        confirmButtonText: "OK"
                    });
                }
