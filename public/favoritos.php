...
<script>
    ...
    let id = $(this).find('button[name="borrar"]').val(); // Obtiene el player_id correctamente
    console.log("Borrado interceptado por AJAX");
    console.log("Datos enviados:", id); 

    $.ajax({
        url: 'borrarJugador.php',  // Reemplaza con el archivo PHP correcto para borrar
        type: 'POST',
        dataType: 'json',
        data: { borrar: id }, // Enviar como objeto
